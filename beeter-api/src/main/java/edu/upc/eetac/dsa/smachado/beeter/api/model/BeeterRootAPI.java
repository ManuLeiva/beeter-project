...
public class BeeterRootAPI {
	@InjectLinks({//absolute.trayectoria de contexto, uri absoluta(http//local....)
		...
		@InjectLink(resource = StingResource.class, style = Style.ABSOLUTE, rel = "stings", title = "Latest stings", type = MediaType.BEETER_API_STING_COLLECTION),//clase con @path("/stings")
	...
	private List<Link> links;//por eso en el postman sale la palabra links
